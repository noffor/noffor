// app/[country]/[lang]/dashboard/saved/page.tsx
"use client";
...
export default function SavedPage() {
  ...
  const saved = [
    { id: 1, name: 'Abdul Karim', category: 'Electrician', rating: 4.2, photo: '/default-avatar.png' },
    { id: 2, name: 'Jamal Uddin', category: 'Plumber', rating: 4.8, photo: '/default-avatar.png' },
  ];
  return (
    <div className="min-h-screen bg-gray-50 pb-20 lg:pb-0">
      <Header country={country} lang={lang} />
      <div className="max-w-lg mx-auto px-3 py-3">
        <h2 className="font-bold text-lg mb-3"><Heart size={20} className="inline mr-2" />Saved</h2>
        <div className="bg-white rounded-xl p-4 border space-y-2">
          {saved.map(s => (
            <div key={s.id} onClick={() => router.push(`/${country}/${lang}/profile/${s.id}`)} className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg cursor-pointer hover:shadow">
